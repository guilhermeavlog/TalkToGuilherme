...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      {/* Suggested questions — fixed left-center */}
      <div className="fixed left-10 top-80 z-10">
        <SuggestedQuestions onSelect={handleTranscript} />
      </div>

      {/* Status indicator — fixed bottom-center */}
      <div className="fixed bottom-8 left-1/2 -translate-x-1/2 z-10">
        <StatusIndicator status={status} />
      </div>

      {/* Text input — fixed bottom-right */}
      <div className="fixed bottom-8 right-8 z-10 flex flex-col items-center gap-2">
        <form
